...
export const chamCongService = {
  ...
  async identifyFace(data) {
    console.log('🌐 API Call - Identify Face');
    const url = `${API_BASE_URL}/cham-cong/identify-face`;
    console.log('📤 Request URL:', url);
    console.log('📤 Request data:', data);
    ...
    try {
      ...
      console.error('💥 Network error (identifyFace):', error.message);
      throw error;
    }
  },
